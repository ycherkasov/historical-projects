...
/*Сделать:
1. Специализация no_case для const char[].
2. Общая библиотека для тестирования и вывода (print_container и тп	)
*/
...
9. Для применения аогоритмов к контейнерам пользуйтесь mem_fun и ptr_fun
...
21.Модифицирующие алгоритмы необязательно пишут изменения 
   во входную последовательность.
22.Использование вставок не позволяет выйти за пределы контейнера 
