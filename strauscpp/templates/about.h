...
2. С конструкторами копирования и операторами присванивания - разобраться.
3. Порядок разрешения видимости при перегрузке и специализации.
*/
...
23.Шаблонные конструкторы и операторы копирования никогда не замещают конструкторов о операторов по умолчанию!
*/
