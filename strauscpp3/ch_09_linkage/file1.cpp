...
// —огласно стандарту, как старому, так и новому, 
// если переменна€ объ€влена с модификатором const и при этом €вно не объ€влена как extern, 
// то она получает внутренне св€зывание(т.е. static)
