...
public:
	...
	// Самое важное назначение конструктора копирования 
	// - поведение при возвращении объекта по значенияю
...
private:
	...
	// Его наследуют все потомки класса!
	static int _counter;
};
...
/** @brief 
Класс, содержащий указатель. Указатель может быть проинициализирован прямо в списке инициализации
*/
