...
* To pre-serve C compatibility, a const is ignored at the highest level of an argument type
...
* A few macros are predefined by the compiler 
	...
	* __STDCPP_THREADS__: 1 if a program can have more than one thread of execution; other-
	wise undefined
