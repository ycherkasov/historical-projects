...
class raw_binary_iarchive
    : public ba::binary_iarchive_impl<raw_binary_iarchive, std::istream::char_type,
        std::istream::traits_type> {

    typedef raw_binary_iarchive derived_t;
    typedef ba::binary_iarchive_impl<raw_binary_iarchive,std::istream::char_type,
...
typedef raw_binary_oarchive naked_raw_binary_oarchive;

BOOST_SERIALIZATION_REGISTER_ARCHIVE(raw_binary_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(raw_binary_oarchive)
