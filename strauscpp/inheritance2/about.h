...
2. static_cast/reinterpret_cast и множественное наследование
3. Паттерн Адаптер - множественное наследование от двух классов, интерфейса и реализации
*/
...
24. Значения по умоляанию в списке параметров виртуальной функции наследуются!
