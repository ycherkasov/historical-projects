...
2. Понижающее преобразование, разобраться (Лаптев стр. 103).
3. Объединение функций-друзей в namespace.
4. Операторы для перечислений (Страуструп стр. 313)
*/

/*
Вопросы:
1. Если вектор содержит указатель на динамический массив, 
   почему sizeof показывает его как локальный массив-член?
*/
