...
* A C++ implementation can be either hosted or freestanding
	* A hosted implementa- tion includes all the standard-library facilities as described in the standard
...
* Names starting with a double underscore (__) or an underscore followed by an uppercase letter (_Foo) 
