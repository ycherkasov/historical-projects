...
void show_parital_spec(){
    ...
    double_stack<void(*)(), void(*)(int)> ds4; // pointers to functions
    double_stack<void(textme::*)(), void(textme::*)(int)> ds5; // pointers to methods - not a pointer!
}
...
void show_literal(){
    ...
    // - использовать передачу по значению, если нужно привести массив к указателю (или перегрузку для массивов)
